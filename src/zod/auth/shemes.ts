...
export const companyLoginScheme = z.object({
    login: z.string().min(1, "Email обов'язковий"),
    password: z.string().min(1, "Пароль обов'язковий"),
});

// Если эти схемы используются с инпутами (строки), лучше коэрсить number:
export const companyValidateSchema = z.object({
    ...
    city_id: z.coerce
        .number()
        .int()
        .positive("ID міста має бути додатним числом"),
    type: z.coerce
        .number()
        .int()
